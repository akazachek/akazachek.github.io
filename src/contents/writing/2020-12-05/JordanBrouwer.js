    ...
    render() {
        return (
            <div class = 'postContent'>
                ...
                <Theorem name = 'Jordan-Brouwer' statement = '
                ...
                <Theorem no = '2' name = 'Transversality-Homotopy' statement = '
                ...
                <p>
                    For \(f\colon X\to Y\) we say that \(f\pitchfork Z\) on a subset \(C\) of \(X\) if {'\\(f\\vert_{C\\cap f^{-1}(Z)}\\pitchfork Z\\)'}. We can slightly strengthen theorem 2, useful in some situations.
                </p>
                <Theorem no = '3' name = 'Extension' statement = '
                ...
                <Theorem no = '5' name = 'Boundary' statement = '
                ...
                <p>
                    Then, for an arbitrary map \(g\) (with all the same conditions as before), we can define \(I_2(g,Z)=I_2(f,Z)\), where \(f\sim g\) is an arbitrary homotopy transversal to \(Z\), which will exist by transversality-homotopy. Our next step in constructing this invariant is to exploit that our hypersurface will be connected.
                </p>
                <Theorem no = '6' statement = 'If \(f\colon X\to Y\) is smooth with equidimensional compact \(X\) and connected \(Y\), then \(I_2(f,\{y\})\) is invariant under choice of \(y\in Y\).' />
                <Proof proof = '
                ...
                <p>
                    At last, we have our central result. Recall that we are assuming we have already proven the complement of our hypersurface consists of the two components as posited in the Jordan-Brouwer theorem statement, and so theorem 7 tells points in the same component have the same winding number.
                </p>
                <Theorem no = '10' statement = '
                ...
                <p>
                    This is astoundingly simple, so I can now rest easy, knowing if I ever find myself in a life-or-death situation where the only escape is by knowing whether a point lies inside or outside a picture, I just need a pencil and straightedge.
                </p>
                <Figure no = '4' src = {Fig4GP} caption = 'Figure 2-19 (89), Guillemin and Pollack' />
            </div>
        )
    }
