      ...
      <div className="coDiv">
        <div className="about centredBox leftMarginWide" id="aboutSec">
          ...
          <p>
            ...
            biggest role is designing and maintaining the new website. During
            the school year, I have an executive role on{" "}
            <a
              className="linkPurple"
            ...
            , the official club of Western's mathematics department. I help
            write and grade our biweekly contests, and organize our
            once-a-semester student seminars.
          </p>
          <p>
